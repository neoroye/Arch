...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(9bd6ffee)", "rgba(ff5abeee)"}, angle = 45 },
            inactive_border = "rgba(c21f1faa)",
        },
...
hl.bind(mainMod .. " + Delete", hl.dsp.exec_cmd("hyprlock --config ~/.config/hypr/hyprlock/hyprlock.conf"))
...
-- Print: área
hl.bind("Print", hl.dsp.exec_cmd([[mkdir -p ~/Pictures/Screenshots && grim -g "$(slurp)" ~/Pictures/Screenshots/$(date +%Y-%m-%d_%H-%M-%S.png)]]))
